...
const instagram = [
  { label: 'Waffle art', src: 'https://images.unsplash.com/photo-1562376552-0d160a2f238d?w=400&h=400&fit=crop' },
  { label: 'Coffee pour', src: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400&h=400&fit=crop' },
  { label: 'Dessert close-up', src: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400&h=400&fit=crop' },
  { label: 'Cafe corner', src: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=400&h=400&fit=crop' },
];
      ...
      <section className="relative min-h-[90dvh] flex items-center justify-center overflow-hidden bg-bg pt-16">
        ...
        <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
          ...
          >
            <Link
              href="/menu"
              className="inline-block px-8 py-3 border border-ink text-ink font-nav text-[12px] tracking-[3px] uppercase no-underline hover:bg-ink hover:text-white transition-all duration-300 focus-visible:outline-2 focus-visible:outline-red focus-visible:outline-offset-2"
            >
              Explore our menu →
            </Link>
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-3 bg-ink text-white font-nav text-[12px] tracking-[3px] uppercase no-underline hover:bg-red transition-colors duration-300 focus-visible:outline-2 focus-visible:outline-red focus-visible:outline-offset-2"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {instagram.map((item, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="aspect-square border border-border group cursor-pointer relative overflow-hidden bg-highlight"
              >
                <img
                  src={item.src}
                  alt={item.label}
